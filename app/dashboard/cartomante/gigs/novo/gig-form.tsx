            ...
            <div className="sticky top-0 z-50 bg-[#0a0a0f]/95 backdrop-blur-md border-b border-white/5 pb-1">
                <div className="container mx-auto px-6 py-6 max-w-6xl">
                    <div className="flex items-center justify-between mb-6">
                        <Link href="/dashboard/cartomante/gigs" className="text-2xl font-bold text-white tracking-tight hover:opacity-80 transition-opacity">
                    ...
                    <div className="flex-1 w-full space-y-12">
                        ...
                        {step === 7 && (
                            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 text-center py-12">
                                ...
                                <div className="pt-12">
                                    <Button
                                        onClick={() => router.push('/dashboard/cartomante/gigs')}
