...
export default async function OrdersPage({
    ...
    if (!user) {
        redirect('/login?next=/dashboard/cartomante/pedidos')
    }
            ...
            <main className="relative z-10 flex-1 h-screen overflow-y-auto scrollbar-hide pb-24 md:pb-8">
                <PageContainer className="px-4 md:px-8 py-6 md:py-12">
                    ...
                    <div className="flex items-center gap-6 border-b border-white/10 mb-8 overflow-x-auto scrollbar-hide">
                        <Link
                            href="/dashboard/cartomante/pedidos?tab=active"
                        ...
                        <Link
                            href="/dashboard/cartomante/pedidos?tab=pending"
                        ...
                        <Link
                            href="/dashboard/cartomante/pedidos?tab=completed"
                        ...
                        <Link
                            href="/dashboard/cartomante/pedidos?tab=canceled"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2 w-full md:w-auto mt-2 md:mt-0 pt-3 md:pt-0 border-t border-white/5 md:border-0 justify-end">
                                            {order.status === 'PAID' && (
                                                <Link href={`/dashboard/cartomante/pedido/${order.id}`} className="flex-1 md:flex-none">
                                                    <Button
                                            ...
                                            <Link href={`/dashboard/cartomante/mensagens?orderId=${order.id}&clientId=${order.client_id}`}>
