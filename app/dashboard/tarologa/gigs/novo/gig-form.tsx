                                ...
                                <div className="flex items-start gap-4 relative z-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-400 leading-relaxed text-sm">
                                            ...
                                            {step === 2 && "Preços competitivos para novas tarólogas variam entre R$ 60 e R$ 150. À medida que você ganha avaliações, pode aumentar seu valor."}
                                            ...
                                            {step === 5 && "60% das tarólogas mais bem avaliadas oferecem Tiragens Digitais por serem fáceis de compartilhar."}
                                        </p>
                                    </div>
                                </div>
