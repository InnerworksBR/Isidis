                                    ...
                                    {formData.avatar_url ? (
                                        <div className="w-full h-full relative">
                                            {/* Since we only have the path, we might need to construct the URL or just show a placeholder if we don't have the public URL logic here. 
                                                ...
                                                Supabase public URL: process.env.NEXT_PUBLIC_SUPABASE_URL + '/storage/v1/object/public/avatars/' + formData.avatar_url
                                             */}
                                            <img
                                                src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/avatars/${formData.avatar_url}`}
                                                alt="Avatar"
