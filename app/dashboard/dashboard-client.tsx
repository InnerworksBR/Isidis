...
export function DashboardClient({
    ...
    // Polling for updates using SWR
    const { mutate } = useSWR('dashboard-orders', null, {
                                                ...
                                                <div className="flex gap-2">
                                                    {isReady && (
                                                        <Button asChild size="sm" className="bg-primary hover:bg-primary/90 gap-1.5 h-8 text-xs font-bold shadow-lg shadow-primary/20">
                                                            <Link href={`/dashboard/leitura/${order.id}`}>
                                                    ...
                                                    {isPaid && (
                                                        <Button
                                                            variant="outline"
                                                            size="sm"
                                                            className="border-blue-500/30 text-blue-400 hover:bg-blue-500/10 h-8 text-xs font-bold"
