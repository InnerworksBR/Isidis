...
export function CartomantesClient({ readers, initialFilters, userId }: CartomantesClientProps) {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            ...
            router.push(`/cartomantes?${params.toString()}`, { scroll: false })
        }, 500)
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-slate-500">
                                <li><Link href="/cartomantes" className="hover:text-indigo-400 transition-colors">Profissionais Top</Link></li>
                            </ul>
                        </div>
        ...
        <div className="rounded-2xl border border-indigo-500/10 bg-[#12122a] hover:border-indigo-500/30 transition-all group overflow-hidden relative">
            ...
            <div className="p-5 -mt-6 relative z-10">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-indigo-500/10">
                    ...
                    >
                        <Link href={`/cartomante/${reader.id}`}>
                            Agendar
